    ...
    return(
        <div className = "Homepage">
            ...
            <div className="HomeIntro">
                ...
                <section>
                    <p>This app acts as a simulation for what Sauti Africa has implemented. A user can see other shop owners locations and item prices, and add an item or location listing to their profile.</p>
